...
$query_Recordset1 = "SELECT * from `clients`  order by Lname limit 10";
...
mysql_select_db($database_furniture, $furniture);
$query_Recordset1 = "SELECT * from `clients` where Lname like '%$lastname%' and Fname like '%$firstname%' ";
$Recordset1 = mysql_query($query_Recordset1, $furniture) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
}
...
mysql_select_db($database_furniture, $furniture);
$query_Recordset1 = "SELECT * from `clients` where Fname like '%$firstname%'  ";
$Recordset1 = mysql_query($query_Recordset1, $furniture) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
}
...
$thecustid=$row_Recordset1['clientid'];
...
?>               
                <div class="one-third-responsive">
                    <p class="user-list-follow">
                        ...
                        <a href="admin_editprofile.php?ID=<?php echo $thecustid ?>&uemail=<?php echo $theemail ?>" class="follow">Edit User</a>
                    </p>
                    <div class="decoration"></div>                
