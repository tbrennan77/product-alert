...
// return a response ===========================================================
  ...
  $insertSQL = sprintf("update `administrators` set username='$pusername', password='$ppassword', Fname='$pfname', Lname='$plname', email='$pemail', phone='$phone'  where admin_id=$pclientid");
