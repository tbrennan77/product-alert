...
// return a response ===========================================================
  ...
  $insertSQL = sprintf("INSERT INTO `hinklema_furniture`.`administrators` (`username`, `password`, `last_login`, `Fname`, `Lname`, `email`, `phone`) VALUES ('$pusername', '$ppassword', '$today', '$pfname', '$plname', '$pemail', '$phone');");
