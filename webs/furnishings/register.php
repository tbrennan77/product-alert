        ...
        <div class="snap-drawer snap-drawer-right sidebar-light-clean">
          ...
          <div id="content" class="snap-content">      
        	<div class="header-clear-large"></div>  
                    ...
                    <h4 class="heading-title">Create Profile</h4>
                        ...
                        <a class="pageapp-signup-logo" href="#"></a>
                         ...
                         <?php if($errormsg!=1){ ?>
                          <div class="pageapp-signup-field">
                             ...
                             <input type="text" value="Username" name="username" id="username" onfocus="if (this.value=='Username') this.value = ''" onblur="if (this.value=='') this.value = 'Username'"class="contactField requiredField requiredEmailField">
                        </div>  
                        <?php } else { ?>
             <div class="static-notification bg-red-dark">
                            
                             <input type="text" value="Username Exists" name="username" id="username" onfocus="if (this.value=='Username Exists') this.value = ''" onblur="if (this.value=='') this.value = 'Username Exists'"class="contactField requiredField requiredEmailField">
                        </div>  
                        <?php } ?>
                        <div class="pageapp-signup-field">
                            
                            <input type="password" value="Password" name="password" id="password" onfocus="if (this.value=='password') this.value = ''" onblur="if (this.value=='') this.value = 'password'"class="contactField requiredField requiredEmailField">
                        </div>       
                        <div class="pageapp-signup-field">
                            
                             <input type="text" value="Firstname" name="firstname" id="firstname" onfocus="if (this.value=='Firstname') this.value = ''" onblur="if (this.value=='') this.value = 'Firstname'"class="contactField requiredField requiredEmailField">
                        </div>                    
                        <div class="pageapp-signup-field">
                            
                            <input type="text" value="Lastname" name="lastname" id="lastname" onfocus="if (this.value=='Lastname') this.value = ''" onblur="if (this.value=='') this.value = 'Lastname'"class="contactField requiredField requiredEmailField">
                        </div>                    
                        <div class="pageapp-signup-field">
                           
                            <input type="text" value="Cell Phone" name="phone" id="phone" onfocus="if (this.value=='Cell Phone') this.value = ''" onblur="if (this.value=='') this.value = 'Cell Phone'"class="contactField requiredField requiredEmailField">
                        </div>
                        
            <div class="pageapp-signup-field">
            
                <input type="text" value="Email Address" name="email" id="email" onfocus="if (this.value=='Email Address') this.value = ''" onblur="if (this.value=='') this.value = 'Email Address'"class="contactField requiredField requiredEmailField">
            </div>   
...
<input type="hidden" name="MM_insert" value="form2" id="MM_insert">
 <a href="#" onClick="javascript: document.form2.submit();" class="pageapp-signup-button button button-small button-green button-fullscreen">Create Account</a>
</div></form>

                       
                    
                     <div class="decoration"></div>
                      <a href="login.php" class="facebook-login facebook-color"><i class="fa fa-backward"></i>Back To Login</a>
                </div>
                </div>
